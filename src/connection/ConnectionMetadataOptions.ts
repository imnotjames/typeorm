...
/**
 * ConnectionMetadataOptions is set of connection options which pertain to the
 * connection rather than any driver.
 */
export interface ConnectionMetadataOptions {
    /**
